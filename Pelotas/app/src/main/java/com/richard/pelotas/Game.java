...
public class Game extends ImageView {
    ...
    public Game(Context contexto, int nivel_dificultad){
        ...
        BitmapDrawable dibujo_fondo=(BitmapDrawable) ContextCompat.getDrawable(contexto, R.drawable.fondo2);
        ...
        BitmapDrawable objetoPelota=(BitmapDrawable)ContextCompat.getDrawable(contexto, R.drawable.diamante);
